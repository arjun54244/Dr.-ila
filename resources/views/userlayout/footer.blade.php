        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="banner3-content">
                    <h2>Subscribe to Our Health Newsletter</h2> 
                    <p>Stay informed about women's health tips, pregnancy care, and gynecological updates.</p>
                    ...
                    <img src="{{asset('assets/img/home2/4.jpeg')}}" alt="" class="vector1">
                    <img src="{{asset('assets/img/home2/7.jpeg')}}" alt="" class="vector2">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-lg-4 gy-5 justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-widget">
                    <div class="footer-logo">
                        <a href="{{route('home')}}"><img src="{{asset('assets/img/home1/main.png')}}" class="img-fluid rounded" style="padding: 5.5px; background-color: #ffff;" alt="Dr. Ila Gupta"></a>
                    </div>
                    <h3>Providing <span>Expert <br></span> Gynecological Care<span>?</span></h3>
                    <a href="{{route('contact')}}" class="primary-btn1">Book an Appointment</a>
                </div> 
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
                <div class="footer-widget">
                    <div class="single-contact mb-30">
                        ...
                        <a href="tel:9972999729">+9972999729</a>
                    </div>
                    <div class="single-contact mb-35">
                        ...
                        <a href="mailto:ilaguptadoc@gmail.com"><span class="__cf_email__" >ilaguptadoc@gmail.com</span></a>
                    </div>
                    <div class="single-contact">
                        ...
                        <a target="_blank" href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3631117,17z/data=!3m1!4b1!4m6!3m5!1s0x3755c14c8682a473:0xa6c74743d52adb88!8m2!3d23.8340663!4d90.3656866!16s%2Fg%2F11rs9vlwsk?entry=ttu">B-4, Chander Nagar, Surya Nagar, Ghaziabad. (Near- Ramprastha, Opp Vivek Vihar.)
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-end justify-content-sm-end">
                <div class="footer-widget">
                    ...
                    <p>Providing compassionate and expert gynecological care with over 35 years of experience. Your health and well-being are our priority.</p>
        ...
        <div class="row">
            <div class="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
                <ul class="social-list">
                    <li>
                        <a target="_blank" href="https://www.facebook.com/Gynaecologist.ilagupta"><i class="bx bxl-facebook"></i></a>
                    </li>
                    <li>
                        <a target="_blank"  href="https://www.linkedin.com/in/dr-ila-gupta-09527812/"><i class="bx bxl-linkedin"></i></a>
                    </li>
                   
                    <li>
                        <a target="_blank"  href="https://www.instagram.com/drila.gupta_gynecologist/"><i class="bx bxl-instagram"></i></a>
                    </li>
                    <li>
                        <a target="_blank"  href="https://www.youtube.com/@ilaguptadoc"><i class="bx bxl-youtube"></i></a>
                    </li>
                </ul>
                <p>©Copyright 2025 Dr.ila Gupta | Design By <a href="https://digidotes.com/">Digidotes </a></p>
