            ...
            <div class="col-lg-4">
                <div class="sidebar-area">
                    ...
                    <div class="single-widget mb-30">
                        ...
                        @foreach (App\Models\Blogs::all() as $blog)
                        <div class="recent-post-widget mb-20">
                            <div class="recent-post-img">
                                <a href="{{route('posts.show',$blog->slug)}}"><img src="{{asset('storage/' . $blog->image)}}" alt=""></a>
                            </div>
                            <div class="recent-post-content">
                                <h6><a href="{{route('posts.show',$blog->slug)}}">{{$blog->title}}</a></h6>
                            </div>
                        </div>
                        @endforeach
                    </div>
